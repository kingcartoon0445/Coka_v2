...
import 'package:source_base/presentation/screens/customers/customer_detail/widgets/customer_journey.dart';
    ...
    return BlocBuilder<CustomerServiceBloc, CustomerServiceState>(
      ...
      return Scaffold(
          appBar: AppBar(
            ...
            title: state.status == CustomerServiceStatus.loading
                ? Shimmer.fromColors(
                    baseColor: Colors.grey[300]!,
                    highlightColor: Colors.grey[100]!,
                    child: Row(children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildCompactAssigneeInfo(state.customerService!),
                            ],
                          ),
                        ),
                      ],
