...
class ProfileRequestItem extends StatelessWidget {
  final InvitationListModel dataItem;
...
class ProfileInviteItem extends StatelessWidget {
  final InvitationListModel dataItem;
  final Function onReload;
        ...
        trailing: Row(
          ...
          children: [
            SizedBox(
              height: 28,
              child: ElevatedButton(
                onPressed: () => _acceptInvitation(context, true),
                style: ElevatedButton.styleFrom(
                  elevation: 0,
                  minimumSize: Size.zero,
            ...
            SizedBox(
              height: 28,
              child: ElevatedButton(
                onPressed: () => _acceptInvitation(context, false),
                style: ElevatedButton.styleFrom(
                  elevation: 0,
                  minimumSize: Size.zero,
                  backgroundColor: Colors.white,
  ...
  void _acceptInvitation(BuildContext context, bool isAccept) {
    final action = isAccept ? 'đồng ý' : 'từ chối';
    final successMessage = isAccept
