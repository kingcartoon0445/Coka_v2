...
//   //     OrganizationRepository(ApiClient());
...
//         offset: 0,
//         searchText:
//             _orgMemberSearchText.isNotEmpty ? _orgMemberSearchText : null,
...
//         widget.workspaceId,
//         searchText:
//             _salesMemberSearchText.isNotEmpty ? _salesMemberSearchText : null,
//       );
...
//                 .assignToCustomer(
//                     widget.organizationId, widget.workspaceId, assignData);
...
//                 SnackBar(
//                     content: Text(
//                         'Đã chuyển phụ trách thành công cho ${member['fullName']}')),
//               );
//             }
//           } catch (e) {
//             if (mounted && !_assignCancelToken!.isCancelled) {
...
//         title: 'Chuyển phụ trách?',
//         subtitle:
//             'Bạn có chắc muốn phân phối data đến đội sale ${team['name']}?',
//         onSubmit: () async {
//           Navigator.pop(dialogContext);
...
//                 SnackBar(
//                     content: Text(
//                         'Đã chuyển phụ trách thành công cho đội sale ${team['name']}')),
//               );
//             }
//           } catch (e) {
//             if (mounted && !_assignCancelToken!.isCancelled) {
