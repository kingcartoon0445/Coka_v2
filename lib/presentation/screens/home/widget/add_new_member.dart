...
/// GỌI DIALOG
Future<void> showOpportunityCreateDialog(BuildContext context) async {
  return showDialog(
    context: context,
...
class _OpportunityCreateDialogState extends State<_OpportunityCreateDialog> {
  ...
  // Dropdown values
  String? _org; // Tổ chức
  String _phoneType = 'Liên hệ chính';
  String _emailType = 'Email chính';
  String? _customerType; // Loại khách hàng
  String? _leadSource; // Nguồn khách hàng
                    ...
                    child: Column(
                      children: [
                        ...
                        ChipsInput<CustomerPaging>(
                          ...
                          initialValue:
                              _customerPaging == null ? [] : [_customerPaging!],
                        ...
                        ChipsInput<UtmSourceModel>(
                          ...
                          initialValue: _utmSource == null ? [] : [_utmSource!],
                          allowInputText: false,
  ...
  void _onSubmit() {
    ...
    // TODO: thu thập dữ liệu và gọi API tạo cơ hội
    // Ví dụ dữ liệu gom lại:
    final payload = {
      'name': _nameCtl.text.trim(),
      'organization': _org,
      'phone': {'type': _phoneType, 'value': _phoneCtl.text.trim()},
      'email': {'type': _emailType, 'value': _emailCtl.text.trim()},
    ...
    Navigator.of(context).pop(payload); // trả payload về nơi gọi nếu cần
  }
}
