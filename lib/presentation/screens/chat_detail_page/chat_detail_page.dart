...
class _ChatDetailPageState extends State<ChatDetailPage> {
  ...
  Future<void> _handleFileSelected(String filePath,
    ...
    try {
      ...
      _showErrorSnackBar(
          isActuallyImage ? 'Không thể gửi ảnh: $e' : 'Không thể gửi file: $e');
    } finally {
      if (mounted) {
        setState(() {
          _isUploading = false;
  ...
  void _showAssignBottomSheet(FacebookChatModel conversation) {
    showModalBottomSheet(
      ...
      builder: (context) => AssignToBottomSheet(
        // currentAssignedId:
        //     conversation.assignName, // TODO: Get actual assigned ID
  ...
  void _showConfirmAssignDialog(Map<String, dynamic> assignData) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
            'Bạn có chắc muốn chuyển cuộc trò chuyện này cho người khác?'),
        actions: [
          TextButton(
  ...
  Widget build(BuildContext context) {
    ...
    FacebookChatModel? foundConversation;
            ...
            child: chatState.isLoading && chatState.messages.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      Message message = chatState.messages[index];
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    height: 36,
                    child: IconButton(
                      onPressed: (chatState.isSending || _isUploading)
                          ? null
                          : _pickFile,
                      padding: EdgeInsets.zero,
                      constraints: const BoxConstraints(),
...
class _MessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Builder(
      builder: (context) {
        ...
        final errorMessage = hasError ? 'error' : null;
  ...
  Widget _buildImageWidget(String url, String type, BuildContext context,
      {bool isLocal = false}) {
  ...
  Widget _buildFileWidget(
      String fileName, VoidCallback onTap, BuildContext context,
      {bool isLocal = false}) {
    return Container(
      margin: const EdgeInsets.only(bottom: 8),
