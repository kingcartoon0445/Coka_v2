...
import 'package:source_base/presentation/screens/shared/widgets/custom_container.dart';
import 'package:source_base/presentation/screens/shared/widgets/image_viewer_page.dart';
...
class CustomerBasicInfoPage extends StatefulWidget {
  ...
  @override
  State<CustomerBasicInfoPage> createState() => _CustomerBasicInfoPageState();
}

class _CustomerBasicInfoPageState extends State<CustomerBasicInfoPage> {
  ...
  List<Map<String, dynamic>> _buildDetailProfileList(
      ...
      },
      {
        ...
        "value": customerData["dob"] != null
            ? DateFormat('dd/MM/yyyy')
                .format(DateTime.parse(customerData["dob"]))
            : ""
      },
      {"name": "Nghề nghiệp", "value": customerData["work"] ?? ""},
      {"name": "Nơi ở", "value": customerData["address"] ?? ""},
      {"name": "CMND/CCCD", "value": customerData["physicalId"] ?? ""},
      {
                ...
                onPressed: () {
                  ...
                  showModalBottomSheet(
                    ...
                    builder: (context) => AssignToBottomSheet(
                      ...
                      defaultAssignees:
                          widget.customerDetail['assignToUsers'] != null
                              ? List<Assignees>.from(
                                  widget.customerDetail['assignToUsers'])
                              : [],
                        ...
                        TextButton(
                          onPressed: () async {
                            try {
                              ...
                              // await ref
                              //     .read(customerDetailProvider(customerId)
                              //         .notifier)
