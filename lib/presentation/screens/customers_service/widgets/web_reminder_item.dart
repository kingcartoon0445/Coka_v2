...
class WebReminderItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final priority = Priority.fromValue(reminder.priority ?? 0);
  ...
  Widget _buildTypeIcon(ScheduleType scheduleType) {
    ...
    return Container(
      ...
      child: Icon(
        scheduleType.icon,
        size: 14,
        color: reminder.isDone == true ? baseColor.withOpacity(0.3) : baseColor,
      ),
    );
  }
      ...
      children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: _getPriorityColor(priority)
                    .withOpacity(reminder.isDone == true ? 0.3 : 1.0),
        ...
        Row(
          children: [
            ...
            if (reminder.content?.isNotEmpty ?? false) ...[
