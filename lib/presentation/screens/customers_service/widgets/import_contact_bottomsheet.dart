...
class ImportContactBottomSheet extends StatefulWidget {
  ...
  @override
  State<ImportContactBottomSheet> createState() =>
      _ImportContactBottomSheetState();
}

class _ImportContactBottomSheetState extends State<ImportContactBottomSheet> {
