  ...
  Widget build(BuildContext context) {
    return MenuAnchor(
      style: MenuStyle(
        ...
        surfaceTintColor: const WidgetStatePropertyAll(AppColors.primary),
      ...
      menuChildren: [
        _buildMenuItem("today".tr(), DateFilterType.today, context),
        _buildMenuItem("yesterday".tr(), DateFilterType.yesterday, context),
        _buildMenuItem(
            "last_days".tr(args: ["7"]), DateFilterType.last7Days, context),
        _buildMenuItem(
            "last_days".tr(args: ["30"]), DateFilterType.last30Days, context),
        _buildMenuItem("this_year".tr(), DateFilterType.thisYear, context),
        _buildMenuItem("all_time".tr(), DateFilterType.allTime, context),
        _buildMenuItem(
          "custom_range".tr() +
              (isExpanded
                  ? "                                                          "
