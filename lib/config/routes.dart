...
class AppPaths {
  ...
  static String messagesConnection(String organizationId) =>
      '/organization/$organizationId/messages';
  ...
  static String settings(String organizationId) =>
      '/organization/$organizationId/settings';
  static String invitations(String organizationId) =>
  ...
  static String customerDetail(
          String organizationId, String workspaceId, String customerId) =>
      '/organization/$organizationId/workspace/$workspaceId/customers/$customerId';
  static String customerBasicInfo(
          String organizationId, String workspaceId, String customerId) =>
  ...
  static String customerReminders(
          String organizationId, String workspaceId, String customerId) =>
...
class AppNavigation {
  ...
  static String goToOrganization(String organizationId) =>
      AppPaths.organization(organizationId);
  ...
  static String goToCustomer(
          String organizationId, String workspaceId, String customerId) =>
      AppPaths.customerDetail(organizationId, workspaceId, customerId);

  // Helper method to navigate to messages
  static String goToMessages(String organizationId) =>
      AppPaths.messages(organizationId);
...
class AppPatterns {
  ...
  static const String workspacePattern =
      '/organization/:organizationId/workspace/:workspaceId';
...
final GoRouter router = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      ...
      builder: (context, state) => VerifyOtpScreen(
        ...
        otpId: state.pathParameters['otpId']!,
      ),
    ),
    GoRoute(
  ...
  // Ví dụ: redirect nếu cần
  // redirect: (context, state) {
  //   final loggedIn = false;
  //   if (!loggedIn && state.subloc != '/login') return '/login';
  //   return null;
  // },
);
