...
class NotificationRepository {
  ...
  Future<Map<String, dynamic>> getUnreadCount() async {
    final response = await _apiClient.get('/api/v1/notify/countunread');
    return response.data;
  }
  ...
  Future<Map<String, dynamic>> setAllNotificationsRead() async {
    final response = await _apiClient.post('/api/v1/notify/readall');
    return response.data;
  }
  ...
  Future<Map<String, dynamic>> getNotificationSettings() async {
    final response = await _apiClient.get('/api/v1/setting/notify/getlist');
    return response.data;
  }
